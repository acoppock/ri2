...
```{r, fig.alt = "Histogram of the randomization distribution of the estimated ATE under the sharp null of no effect, with a vertical line at the observed estimate."}
library(ri2)
N <- 100
...
```{r, out.height = "50px", echo=FALSE, fig.alt = "EGAP logo"}
